...
class RdProtocolModel private constructor(
    ...
    companion object : ISerializersOwner {
        ...
        override fun registerSerializersCore(serializers: ISerializers)  {
            ...
            serializers.register(LazyCompanionMarshaller(RdId(17447450570952382), classLoader, "com.jetbrains.rider.plugins.rdprotocol.CustomType"))
        }
...
data class CustomType (
    ...
    companion object : IMarshaller<CustomType> {
        ...
        override val id: RdId get() = RdId(17447450570952382)
